...
SECRET_KEY = "django-insecure-$g1%1&y^va!t_zfq&lmhi0j_18gvk&ykzg25%8%mli6_nd5yx!"
...
DATABASES = {
    'default': {
        ...
        'USER': config('DATABASE_USER', default='myusername'),
...
MAILERSEND_FROM_EMAIL = config('MAILERSEND_FROM_EMAIL')
